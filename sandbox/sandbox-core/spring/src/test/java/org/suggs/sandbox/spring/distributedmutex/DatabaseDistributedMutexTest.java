...
import org.suggs.sandbox.spring.distributedmutex.impl.DatabaseDistributedMutex;
...
public class DatabaseDistributedMutexTest {
    ...
    public void onSetup() {
        if ( jdbcTemplate == null ) {
            throw new IllegalStateException( "Null jdbc template in the Distributed Mutex test" );
        }
