...
/**
 * Schema creation class uses the hibernate configuration to drive the creation of the schema
 * 
 * @author suggitpe
...
public class SchemaCreator {
    ...
    /**
     * Main method that will manage the passing of the files to the hibernate impl
     * 
     * @param aDestDir
    ...
    /**
     * This method will create a new file in the destination directory after archiving off the exiting files
    ...
    /**
     * Method to interact to the hibernate interface to manage the underlying sql file creation
     * 
     * @param aDestFilename
     *            a destination filename for the sql file
     * @param aCfg
     *            Configuartion obejct used by the schemaexport process
     */
