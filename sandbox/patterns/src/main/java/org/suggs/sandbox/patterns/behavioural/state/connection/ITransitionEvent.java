...
/**
 * Interface to define an event for a transition. One of the ways to
 * evaluate whether a transition is valid or not is by way of event
 * where the named event on the transition is matched against that on
 * the event context.
 * 
 * @author suggitpe
