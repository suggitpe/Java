...
/**
 * Class to encapsulate a caffeinated beverage. In this method we
 * define that all subclassses must implement a method called
 * prepareRecipe and provide some common methods that can be called if
 * needed.
 * 
 * @author suggitpe
