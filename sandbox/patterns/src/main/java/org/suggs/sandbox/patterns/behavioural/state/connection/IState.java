...
/**
 * Interface to represent a State. Each state should be responsible
 * for receiving calls to its own step method so that it can evaluate
 * (or delegate) the evaluation of the transitioning process between
 * the states.
 * 
 * @author suggitpe
...
public interface IState
{
     ...
     *         transition, or if there is no state transition
     *         performed, then it will return itself.
     */
