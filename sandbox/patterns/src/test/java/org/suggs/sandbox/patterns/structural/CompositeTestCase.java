...
public class CompositeTestCase extends AbstractPatternTestCase
{
    ...
    /**
     * Test the print method in the waitress.
     */
    ...
    private IMenuComponent buildMenus()
    {
        ...
        pancakeHouseMenu.add( new MenuItem( "K&B's pancake breakfast", "Pancakes with scrambled egss and toast", true, 2.99d ) );
        pancakeHouseMenu.add( new MenuItem( "Regular pancake breakfast", "Pancakes with fried eggs and sausage", false, 2.99d ) );
        ...
        dinerMenu.add( new MenuItem( "Vegetarian BLT", "'Fakin' bacon with lettuce & tomato on whie bread", true, 2.99d ) );
        ...
        cafeMenu.add( new MenuItem( "Steak and Chips", "Fillet steak with lashings of pepper sauce", false, 13.99d ) );
        ...
        cafeMenu.add( new MenuItem( "Sausage 'n mash", "Apple and cider sausages with egg spaghetti", false, 7.49d ) );

        dessertMenu.add( new MenuItem( "Spotted Dick ", "Sponge with currents and fruit zest", true, 3.99d ) );
        dessertMenu.add( new MenuItem( "Fresh fruit", "A select of the freshest fruit known to man!", true, 3.99d ) );
        ...
        dessertMenu.add( new MenuItem( "Cheese platter", "A selection of cheeses from around thre world", true, 5.99d ) );
