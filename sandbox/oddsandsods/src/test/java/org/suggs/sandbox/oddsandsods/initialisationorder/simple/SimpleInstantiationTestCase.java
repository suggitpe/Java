...
/**
 * Test case for the simple instantiation classes. The purpose of this test is to show you that the order of
 * execution is as follows:
 * <ol>
 * <li>SuperClass constructor is called</li>
 * <li>SuperClass constructor calls printThree which is overloaded by the base class</li>
 * <li>printThree in the TestClass uses the uninitialised variable of 'three' and thus prints 0 (the default
 * int initialisation value)</li>
