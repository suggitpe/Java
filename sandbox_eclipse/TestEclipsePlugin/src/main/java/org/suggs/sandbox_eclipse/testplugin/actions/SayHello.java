 ...
 */
public class SayHello implements IWorkbenchWindowActionDelegate
{
    ...
    public SayHello()
    {
        System.out.println( "Test is the SayHelo action being created" );
    }

    /**
     * The action has been activated. The argument of the method
     * represents the 'real' action sitting in the workbench UI.
     * 
     * @see IWorkbenchWindowActionDelegate#run
     */
    public void run( IAction action )
    {
        MessageDialog.openInformation( mWindow.getShell(),
                                       "Sandbox Test Eclipse Plugin",
                                       "Hello World, from the Sandbox Test Eclipse Plugin" );
        IResource s;
    }
