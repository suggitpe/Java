...
/**
 * The purpose of this interface is to provide a way such that we can
 * decouple the construction of the menus in the system away from the
 * main GUI logic.
 * 
 * @author suggitpe
...
public interface IMenuFactory
{
     ...
     * 
     * @param menuType
     *            the type of menu that you would like to create (e.g.
