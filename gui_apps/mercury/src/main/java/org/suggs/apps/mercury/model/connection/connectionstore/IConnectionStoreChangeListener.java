...
/**
 * This interface encapsulates the event of change in the connection
 * store. This basically allows for observers to register interest in
 * changes in the connection store.
 * 
 * @author suggitpe
