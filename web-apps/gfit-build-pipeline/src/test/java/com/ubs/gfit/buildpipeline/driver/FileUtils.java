...
public final class FileUtils {
    ...
    private ComponentImpl createFreshComponentDirectory( String aComponentName, File aComponentInstallDir ) {
    ...
    public String readComponentInstallDirectory() throws IOException {
    ...
    private void deleteComponentDirectoryIfExists( final String aDirectoryToDelete, File aComponentInstallDir ) {
    ...
    private void recursivelyDeleteFilesInDirectoryWithName( File aFileLocationDirectory ) {
    ...
    private int countNumberOfFilesInDirectoryWithName( final String aNameOfFile, File aDirectoryToSearchThrough ) {
